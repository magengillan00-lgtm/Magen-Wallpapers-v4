...
@Composable
fun ChangeOnUnlockSwitch(
    changeOnUnlock: Boolean,
    ...
    Surface(
        ...
        Row(
            ...
            Column(
                ...
                Text(
                    text = stringResource(R.string.change_wallpaper_when_device_unlocked),
            ...
            Switch(
                ...
                onCheckedChange = onChangeOnUnlockChange
            )
        }
    }
}
