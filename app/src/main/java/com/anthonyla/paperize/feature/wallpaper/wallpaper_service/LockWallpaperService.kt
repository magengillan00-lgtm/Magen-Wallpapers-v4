...
class LockWallpaperService: Service() {
    companion object {
        ...
        private const val WAKELOCK_TAG = "Paperize:LockWallpaperService"
    ...
    override fun onCreate() {
        ...
        try {
            ...
            Log.d("LockWallpaperService", "WakeLock acquired")
        } catch (e: Exception) {
            Log.e("LockWallpaperService", "Failed to acquire WakeLock", e)
        }
        if (!isForeground) {
    ...
    override fun onDestroy() {
        ...
        try {
            if (wakeLock?.isHeld == true) {
                wakeLock?.release()
                Log.d("LockWallpaperService", "WakeLock released")
            }
            wakeLock = null
        } catch (e: Exception) {
            Log.e("LockWallpaperService", "Failed to release WakeLock", e)
        }
    }
    ...
    private suspend fun changeWallpaper(context: Context) {
        try {
            ...
            Log.e("AutoWallpaperChangerPro", "Error in changing wallpaper (Lock)", e)
        }
    }
